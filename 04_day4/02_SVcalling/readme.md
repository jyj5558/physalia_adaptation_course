...
ln -s $CLUSTER_SCRATCH/AdapGenom/Share/WGS_bam/* .

### Run delly to call SVs on all samples combined
ml biocontainers
ml delly
delly call -g $CLUSTER_SCRATCH/AdapGenom/Share/ressources/genome_mallotus_dummy.fasta -o svs_delly/capelin_sv.bcf BELB9.bam BELD3.bam BLA13.bam BLA15.bam BLA16.bam BLA17.bam BLA22.bam BLA24.bam BSO17.bam BSO23.bam BSO28.bam POR19.bam 
...
cp $CLUSTER_SCRATCH/AdapGenom/Share/WGS_bam/svs_delly/capelin_sv.vcf $CLUSTER_SCRATCH/AdapGenom/wgr/svs_delly/.

#copy also the popmap file
cp $CLUSTER_SCRATCH/AdapGenom/Share/WGS_bam/svs_delly/popmap_capelin_wgr_delly.txt $CLUSTER_SCRATCH/AdapGenom/wgr/svs_delly/.
```
...
```
cd $CLUSTER_SCRATCH/AdapGenom/wgr/snps_bcftools
cp $CLUSTER_SCRATCH/AdapGenom/Share/WGS_bam/snps_bcftools/capelin_wgs_filtered.vcf $CLUSTER_SCRATCH/AdapGenom/wgr/snps_bcftools/.
cp $CLUSTER_SCRATCH/AdapGenom/Share/WGS_bam/snps_bcftools/capelin_wgs_filtered.012 $CLUSTER_SCRATCH/AdapGenom/wgr/snps_bcftools/.
cp $CLUSTER_SCRATCH/AdapGenom/Share/WGS_bam/snps_bcftools/capelin_wgs_filtered.012* $CLUSTER_SCRATCH/AdapGenom/wgr/snps_bcftools/.
```
